...
|PCL|Значение вероятности фишинга для сообщения. Дополнительные сведения об этом значении приведены [здесь](anti-spam-message-headers.md#PCL).  |
