...
Компонент анализа безопасные вложения является частью [Защиты расширенного Threat Office 365](office-365-atp.md). Безопасные вложения ATP функции применяются при:
