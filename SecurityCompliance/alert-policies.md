...
- **Источник** — используйте этот фильтр для отображения оповещений запущено с политик безопасности & центре соответствия требованиям или активированных политик безопасности приложения Office 365 облака или оба предупреждений. Дополнительные сведения о безопасности приложения Office 365 облачных оповещений [Просмотр безопасности приложения облачных оповещения](#viewing-cloud-app-security-alerts) см.
...
Оповещения, активируемые политик безопасности Office 365 облаке приложения отображаются на странице **Просмотр оповещений** в центр соответствия требованиям и безопасности. Этот компонент включает оповещения, активируемые активности политик и оповещения, активируемые политик обнаружения неполадок в облаке приложения Office 365 безопасности. Это означает, что вы можете просмотреть все оповещения в центр соответствия требованиям и безопасности. Обратите внимание, что безопасности приложения Office 365 облаке доступна только для организаций с Office 365 корпоративный E5 или Office 365 "мне Нравится" государственных G5 подписки. Для получения дополнительных сведений см [Overview of Office 365 облачных безопасности приложения](office-365-cas-overview.md).

Кроме того, организациями, которые имеют Microsoft Cloud безопасности приложения в рамках предприятия мобильности + подписки E5 безопасности или как автономную службу безопасности приложения облачных оповещений, просмотр можно также связаны с приложениями Office 365 и службами безопасности & Центр соответствия.

Для отображения только оповещения о безопасности приложения облака в центр соответствия требованиям и безопасности, используйте фильтр **источника** и выберите **Безопасность приложения в облаке**.
