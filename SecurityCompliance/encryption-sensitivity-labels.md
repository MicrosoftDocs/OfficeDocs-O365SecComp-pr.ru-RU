...
Чтобы начать, просто установите переключатель **Шифрование** в положение **Включить**, а затем с помощью вариантов ниже можно контролировать, кто может выполнять доступ к электронной почте или документам, которым присваивается эта метка. Вам доступны приведенные ниже возможности.
...
2. **Разрешение окончания срока действия доступа к содержимому** на определенную дату или после определенного количества дней, после того как метка будет применена. После этого пользователи не смогут открывать элемент с меткой. Если указать дату, действительным сроком ее наступления будет считаться соответствующая дата на момент полночи в вашем текущем часовом поясе. 
