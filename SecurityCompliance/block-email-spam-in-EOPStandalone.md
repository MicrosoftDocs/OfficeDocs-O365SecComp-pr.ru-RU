...
3. Добавьте IP-адрес в список заблокированных IP-адресов, выполнив действия, описанные в разделе "Изменение политики фильтров подключений по умолчанию с помощью Центра администрирования Exchange" статьи [Настройка политики фильтров подключений](https://technet.microsoft.com/en-us/library/jj200718%28v=exchg.150%29.aspx).
...
[Настройте политики фильтра нежелательной почты](https://technet.microsoft.com/en-us/library/jj200684%28v=exchg.150%29.aspx), чтобы добавить адрес или домен отправителя в список заблокированных отправителей или доменов. Сообщения с адресов и доменов из списков блокировки для фильтра нежелательной почты отмечаются как спам. 
...
> [!NOTE]
> Дополнительные сведения о списках надежных отправителей см. в статье [Списки надежных и заблокированных отправителей в Exchange Online](https://technet.microsoft.com/en-us/library/dn133608%28v=exchg.150%29.aspx). 
