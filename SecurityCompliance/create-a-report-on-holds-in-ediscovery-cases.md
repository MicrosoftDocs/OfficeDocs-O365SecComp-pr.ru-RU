...
## <a name="step-1-connect-to-the-security-amp-compliance-center-using-remote-powershell"></a>Шаг 1: подключение к центру соответствия &amp; требованиям безопасности с помощью удаленной оболочки PowerShell

Первым этапом является подключение Windows PowerShell к центру безопасности &amp; и соответствия требованиям вашей организации.
...
После подключения к центру соответствия требованиям безопасности &amp; с помощью удаленной оболочки PowerShell необходимо создать и запустить сценарий, собирающий сведения о вариантах обнаружения электронных данных в Организации. 
