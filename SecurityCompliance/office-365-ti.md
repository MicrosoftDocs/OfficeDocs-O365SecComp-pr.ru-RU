...
## <a name="learn-more-about-malware-and-threats"></a>Дополнительные сведения о вредоносных программах и угрозах
...
4. Назначьте лицензии Office 365 Advanced Threat Protection Plan 2 всем активным пользователям. (В отчетах могут отображаться только те пользователи, у которых есть лицензия на это значение, например Explorer.)
...
5. Назначьте роли пользователям в вашей организации, которые будут работать с Office 365 Advanced Threat protection. Ознакомьтесь со статьей [предоставление пользователям доступа к центру &amp; безопасности и соответствия требованиям Office 365](grant-access-to-the-security-and-compliance-center.md)и ознакомьтесь со следующей таблицей:<br/>
  ...
  |Использование [обозревателя угроз (и обнаружения в реальном времени)](threat-explorer.md) для анализа угроз  <br/> |Глобальный администратор Office 365  <br/> Администратор безопасности (назначенный в центре &amp; соответствия требованиям безопасности)  <br/> Средство чтения безопасности (назначено в &amp; центре соответствия требованиям безопасности)  <br/> |
  ...
  |Интеграция Office 365 Advanced Threat Protection Plan 2 с защитником Майкрософт для ATP  <br/> Интеграция Office 365 Advanced Threat Protection Plan 2 с сервером SIEM  <br/> |Глобальный администратор Office 365  <br/> Администратор безопасности (назначенный в центре &amp; соответствия требованиям безопасности)  <br/> Соответствующая роль, назначенная в дополнительных приложениях (таких как центр безопасности защитника Майкрософт или сервер SIEM)  <br/> |
