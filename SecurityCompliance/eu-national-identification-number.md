...
<span data-ttu-id="adee6-111">24 символа:</span><span class="sxs-lookup"><span data-stu-id="adee6-111">24 characters:</span></span>
...
<span data-ttu-id="adee6-122">Австрийский номер удостоверения</span><span class="sxs-lookup"><span data-stu-id="adee6-122">austrian identity number</span></span>
...
- <span data-ttu-id="adee6-137">Одна контрольная цифра</span><span class="sxs-lookup"><span data-stu-id="adee6-137">One check digit</span></span>
...
#### <a name="keywordsbulgarianationalnumber"></a><span data-ttu-id="adee6-147">Кэйвордс_булгариа_натионал_нумбер</span><span class="sxs-lookup"><span data-stu-id="adee6-147">Keywords_bulgaria_national_number</span></span>
...
<span data-ttu-id="adee6-166">Дополнительные сведения см. в разделе "номер идентификатора Хорватия" [, в котором ищутся типы конфиденциальной информации](what-the-sensitive-information-types-look-for.md).</span><span class="sxs-lookup"><span data-stu-id="adee6-166">For details, see the section "Croatia Identity Number" in [What the sensitive information types look for](what-the-sensitive-information-types-look-for.md).</span></span>
...
### <a name="keywords"></a><span data-ttu-id="adee6-178">Ключевые слова</span><span class="sxs-lookup"><span data-stu-id="adee6-178">Keywords</span></span>
...
<span data-ttu-id="adee6-191">11 цифр без пробелов и разделителей</span><span class="sxs-lookup"><span data-stu-id="adee6-191">11 digits without spaces and delimiters</span></span>
...
- <span data-ttu-id="adee6-205">Функция `Func_estonia_eu_national_id_card` находит содержимое, которое соответствует шаблону.</span><span class="sxs-lookup"><span data-stu-id="adee6-205">The function  `Func_estonia_eu_national_id_card` finds content that matches the pattern.</span></span> 
...
<span data-ttu-id="adee6-218">Дополнительные сведения можно найти в разделе "Финляндия национального ID", в котором [ищутся типы конфиденциальной информации](what-the-sensitive-information-types-look-for.md).</span><span class="sxs-lookup"><span data-stu-id="adee6-218">For details, see the section "Finland National ID" in [What the sensitive information types look for](what-the-sensitive-information-types-look-for.md).</span></span>
...
<span data-ttu-id="adee6-229">11 цифр:</span><span class="sxs-lookup"><span data-stu-id="adee6-229">11 digits:</span></span>
...
### <a name="keywords"></a><span data-ttu-id="adee6-242">Ключевые слова</span><span class="sxs-lookup"><span data-stu-id="adee6-242">Keywords</span></span>
...
<span data-ttu-id="adee6-257">До 01 января 2013:</span><span class="sxs-lookup"><span data-stu-id="adee6-257">Prior to 01 January 2013:</span></span>
...
### <a name="keywords"></a><span data-ttu-id="adee6-269">Ключевые слова</span><span class="sxs-lookup"><span data-stu-id="adee6-269">Keywords</span></span>
...
- <span data-ttu-id="adee6-286">Три буквы, соответствующие первым трем согласным в имени семейства</span><span class="sxs-lookup"><span data-stu-id="adee6-286">Three letters that correspond to the first three consonants in the family name</span></span>
...
<span data-ttu-id="adee6-311">Нумеро цертификато персональный</span><span class="sxs-lookup"><span data-stu-id="adee6-311">numero certificato personale</span></span>
...
### <a name="definition"></a><span data-ttu-id="adee6-327">Определение</span><span class="sxs-lookup"><span data-stu-id="adee6-327">Definition</span></span>
...
<span data-ttu-id="adee6-337">личный номер сертификата</span><span class="sxs-lookup"><span data-stu-id="adee6-337">personal certificate number</span></span>
...
### <a name="definition"></a><span data-ttu-id="adee6-353">Определение</span><span class="sxs-lookup"><span data-stu-id="adee6-353">Definition</span></span>
...
<span data-ttu-id="adee6-362">уникальный идентификационный номер</span><span class="sxs-lookup"><span data-stu-id="adee6-362">unique identification number</span></span>
...
- <span data-ttu-id="adee6-379">Три цифры, которые соответствуют серийному числу даты рождения.</span><span class="sxs-lookup"><span data-stu-id="adee6-379">Three digits that correspond to the serial number of the date of birth</span></span>
...
<span data-ttu-id="adee6-390">личный идентификационный номер</span><span class="sxs-lookup"><span data-stu-id="adee6-390">personal id number</span></span>
...
### <a name="pattern"></a><span data-ttu-id="adee6-409">Шаблон</span><span class="sxs-lookup"><span data-stu-id="adee6-409">Pattern</span></span>
...
### <a name="keywords"></a><span data-ttu-id="adee6-421">Ключевые слова</span><span class="sxs-lookup"><span data-stu-id="adee6-421">Keywords</span></span>
...
<span data-ttu-id="adee6-438">Да</span><span class="sxs-lookup"><span data-stu-id="adee6-438">Yes</span></span>
...
<span data-ttu-id="adee6-447">персональный числовой код</span><span class="sxs-lookup"><span data-stu-id="adee6-447">personal numeric code</span></span>
...
### <a name="format"></a><span data-ttu-id="adee6-463">Формат</span><span class="sxs-lookup"><span data-stu-id="adee6-463">Format</span></span>
...
### <a name="keywords"></a><span data-ttu-id="adee6-475">Ключевые слова</span><span class="sxs-lookup"><span data-stu-id="adee6-475">Keywords</span></span>
...
<span data-ttu-id="adee6-494">коднумерикперсонал #</span><span class="sxs-lookup"><span data-stu-id="adee6-494">codnumericpersonal#</span></span>
...
<span data-ttu-id="adee6-500">Десять цифр, содержащих одну обратную косую черту:</span><span class="sxs-lookup"><span data-stu-id="adee6-500">Ten digits containing one backslash:</span></span>
  
### <a name="checksum"></a><span data-ttu-id="adee6-501">Контрольная сумма</span><span class="sxs-lookup"><span data-stu-id="adee6-501">Checksum</span></span>

<span data-ttu-id="adee6-502">Да</span><span class="sxs-lookup"><span data-stu-id="adee6-502">Yes</span></span>
  
### <a name="definition"></a><span data-ttu-id="adee6-503">Определение</span><span class="sxs-lookup"><span data-stu-id="adee6-503">Definition</span></span>

<span data-ttu-id="adee6-504">Политика защиты от потери данных с вероятностью в 85 % верно обнаруживает этот тип конфиденциальной информации, если в расположении, не отдаленном более чем на 300 знаков:</span><span class="sxs-lookup"><span data-stu-id="adee6-504">A DLP policy is 85% confident that it's detected this type of sensitive information if, within a proximity of 300 characters:</span></span>
  
- <span data-ttu-id="adee6-505">Функция `Func_slovakia_eu_national_id_card` находит содержимое, которое соответствует шаблону.</span><span class="sxs-lookup"><span data-stu-id="adee6-505">The function  `Func_slovakia_eu_national_id_card` finds content that matches the pattern.</span></span> 
    
- <span data-ttu-id="adee6-506">Найдено ключевое `Keywords_slovakia_eu_national_id_card` слово FROM.</span><span class="sxs-lookup"><span data-stu-id="adee6-506">A keyword from  `Keywords_slovakia_eu_national_id_card` is found.</span></span> 
    
<span data-ttu-id="adee6-507">Политика защиты от потери данных с вероятностью в 75 % верно обнаруживает этот тип конфиденциальной информации, если в расположении, не отдаленном более чем на 300 знаков:</span><span class="sxs-lookup"><span data-stu-id="adee6-507">A DLP policy is 75% confident that it's detected this type of sensitive information if, within a proximity of 300 characters:</span></span>
  
- <span data-ttu-id="adee6-508">Функция `Func_slovakia_eu_national_id_card` находит содержимое, которое соответствует шаблону.</span><span class="sxs-lookup"><span data-stu-id="adee6-508">The function  `Func_slovakia_eu_national_id_card` finds content that matches the pattern.</span></span> 
...
### <a name="keywords"></a><span data-ttu-id="adee6-509">Ключевые слова</span><span class="sxs-lookup"><span data-stu-id="adee6-509">Keywords</span></span>

#### <a name="keywordsslovakiaeunationalidcard"></a><span data-ttu-id="adee6-510">Кэйвордс_словакиа_еу_натионал_ид_кард</span><span class="sxs-lookup"><span data-stu-id="adee6-510">Keywords_slovakia_eu_national_id_card</span></span>

<span data-ttu-id="adee6-511">номер рождения</span><span class="sxs-lookup"><span data-stu-id="adee6-511">birth number</span></span>
  
<span data-ttu-id="adee6-512">Национальный идентификационный номер</span><span class="sxs-lookup"><span data-stu-id="adee6-512">national identification number</span></span>
  
<span data-ttu-id="adee6-513">персональный идентификационный номер</span><span class="sxs-lookup"><span data-stu-id="adee6-513">personal identification number</span></span>
  
<span data-ttu-id="adee6-514">social security number
</span><span class="sxs-lookup"><span data-stu-id="adee6-514">social security number</span></span>
  
<span data-ttu-id="adee6-515">натионалнумбер #</span><span class="sxs-lookup"><span data-stu-id="adee6-515">nationalnumber#</span></span>
  
<span data-ttu-id="adee6-516">SSN</span><span class="sxs-lookup"><span data-stu-id="adee6-516">ssn#</span></span>
  
<span data-ttu-id="adee6-517">SSN</span><span class="sxs-lookup"><span data-stu-id="adee6-517">ssn</span></span>
  
<span data-ttu-id="adee6-518">номер страны</span><span class="sxs-lookup"><span data-stu-id="adee6-518">national number</span></span>
  
<span data-ttu-id="adee6-519">личный идентификационный номер</span><span class="sxs-lookup"><span data-stu-id="adee6-519">personal id number</span></span>
  
<span data-ttu-id="adee6-520">персоналиднумбер #</span><span class="sxs-lookup"><span data-stu-id="adee6-520">personalidnumber#</span></span>
  
<span data-ttu-id="adee6-521">рč</span><span class="sxs-lookup"><span data-stu-id="adee6-521">rč</span></span>
  
<span data-ttu-id="adee6-522">роднé číсло</span><span class="sxs-lookup"><span data-stu-id="adee6-522">rodné číslo</span></span>
  
<span data-ttu-id="adee6-523">родне Цисло</span><span class="sxs-lookup"><span data-stu-id="adee6-523">rodne cislo</span></span>
  
## <a name="slovenia"></a><span data-ttu-id="adee6-524">Словения</span><span class="sxs-lookup"><span data-stu-id="adee6-524">Slovenia</span></span>

### <a name="format"></a><span data-ttu-id="adee6-525">Формат</span><span class="sxs-lookup"><span data-stu-id="adee6-525">Format</span></span>

<span data-ttu-id="adee6-526">13 цифр без пробелов и разделителей</span><span class="sxs-lookup"><span data-stu-id="adee6-526">13 digits without spaces or delimiters</span></span>
  
### <a name="pattern"></a><span data-ttu-id="adee6-527">Шаблон</span><span class="sxs-lookup"><span data-stu-id="adee6-527">Pattern</span></span>

<span data-ttu-id="adee6-528">13 цифр в указанном шаблоне:</span><span class="sxs-lookup"><span data-stu-id="adee6-528">13 digits in the specified pattern:</span></span>
  
-  <span data-ttu-id="adee6-529">Семь цифр, которые соответствуют дате рождения (ДДММЛЛЛ), где "ЛЛЛ" соответствует последним трем цифрам года рождения</span><span class="sxs-lookup"><span data-stu-id="adee6-529">Seven digits that correspond to the birth date (DDMMLLL) where "LLL" corresponds to the last three digits of the birth year</span></span> 
    
- <span data-ttu-id="adee6-530">Две цифры, соответствующие области рождения</span><span class="sxs-lookup"><span data-stu-id="adee6-530">Two digits that correspond to the area of birth</span></span>
    
- <span data-ttu-id="adee6-531">Три цифры, которые соответствуют сочетанию пола и серийного номера для людей, которые приставили один и тот же день (000-499 для пола и 500-999 для розетки)</span><span class="sxs-lookup"><span data-stu-id="adee6-531">Three digits that correspond to a combination of gender and serial number for persons born on the same day (000-499 for male and 500-999 for female)</span></span>
    
- <span data-ttu-id="adee6-532">Одна контрольная цифра</span><span class="sxs-lookup"><span data-stu-id="adee6-532">One check digit</span></span>
    
### <a name="checksum"></a><span data-ttu-id="adee6-533">Контрольная сумма</span><span class="sxs-lookup"><span data-stu-id="adee6-533">Checksum</span></span>

<span data-ttu-id="adee6-534">Да</span><span class="sxs-lookup"><span data-stu-id="adee6-534">Yes</span></span>
  
### <a name="definition"></a><span data-ttu-id="adee6-535">Определение</span><span class="sxs-lookup"><span data-stu-id="adee6-535">Definition</span></span>

<span data-ttu-id="adee6-536">Политика защиты от потери данных с вероятностью в 85 % верно обнаруживает этот тип конфиденциальной информации, если в расположении, не отдаленном более чем на 300 знаков:</span><span class="sxs-lookup"><span data-stu-id="adee6-536">A DLP policy is 85% confident that it's detected this type of sensitive information if, within a proximity of 300 characters:</span></span>
  
- <span data-ttu-id="adee6-537">Функция `Func_slovenia_eu_national_id_card` находит содержимое, которое соответствует шаблону.</span><span class="sxs-lookup"><span data-stu-id="adee6-537">The function  `Func_slovenia_eu_national_id_card` finds content that matches the pattern.</span></span> 
    
- <span data-ttu-id="adee6-538">Найдено ключевое `Keywords_slovenia_eu_national_id_card` слово FROM.</span><span class="sxs-lookup"><span data-stu-id="adee6-538">A keyword from  `Keywords_slovenia_eu_national_id_card` is found.</span></span> 
    
<span data-ttu-id="adee6-539">Политика защиты от потери данных с вероятностью в 75 % верно обнаруживает этот тип конфиденциальной информации, если в расположении, не отдаленном более чем на 300 знаков:</span><span class="sxs-lookup"><span data-stu-id="adee6-539">A DLP policy is 75% confident that it's detected this type of sensitive information if, within a proximity of 300 characters:</span></span>
  
- <span data-ttu-id="adee6-540">Функция `Func_slovenia_eu_national_id_card` находит содержимое, которое соответствует шаблону.</span><span class="sxs-lookup"><span data-stu-id="adee6-540">The function  `Func_slovenia_eu_national_id_card` finds content that matches the pattern.</span></span> 
...
### <a name="keywords"></a><span data-ttu-id="adee6-541">Ключевые слова</span><span class="sxs-lookup"><span data-stu-id="adee6-541">Keywords</span></span>

#### <a name="keywordssloveniaeunationalidcard"></a><span data-ttu-id="adee6-542">Кэйвордс_словениа_еу_натионал_ид_кард</span><span class="sxs-lookup"><span data-stu-id="adee6-542">Keywords_slovenia_eu_national_id_card</span></span>

<span data-ttu-id="adee6-543">персональный числовой код</span><span class="sxs-lookup"><span data-stu-id="adee6-543">personal numeric code</span></span>
  
<span data-ttu-id="adee6-544">уникальный идентификационный номер</span><span class="sxs-lookup"><span data-stu-id="adee6-544">unique identification number</span></span>
  
<span data-ttu-id="adee6-545">уникальный регистрационный номер</span><span class="sxs-lookup"><span data-stu-id="adee6-545">unique registration number</span></span>
  
<span data-ttu-id="adee6-546">уникальный идентификационный номер</span><span class="sxs-lookup"><span data-stu-id="adee6-546">unique identity number</span></span>
  
<span data-ttu-id="adee6-547">уникуеидентитино #</span><span class="sxs-lookup"><span data-stu-id="adee6-547">uniqueidentityno#</span></span>
  
<span data-ttu-id="adee6-548">уникальный основной номер</span><span class="sxs-lookup"><span data-stu-id="adee6-548">unique master citizen number</span></span>
  
<span data-ttu-id="adee6-549">единствена идентификаЦижска šтевилка</span><span class="sxs-lookup"><span data-stu-id="adee6-549">edinstvena identifikacijska številka</span></span>
  
<span data-ttu-id="adee6-550">уникуеидентитино #</span><span class="sxs-lookup"><span data-stu-id="adee6-550">uniqueidentityno #</span></span>
  
<span data-ttu-id="adee6-551">единствена šтевилка главнега дрžавлжана</span><span class="sxs-lookup"><span data-stu-id="adee6-551">edinstvena številka glavnega državljana</span></span>
  
<span data-ttu-id="adee6-552">емšо</span><span class="sxs-lookup"><span data-stu-id="adee6-552">emšo</span></span>
  
## <a name="spain"></a><span data-ttu-id="adee6-553">Испания</span><span class="sxs-lookup"><span data-stu-id="adee6-553">Spain</span></span>

### <a name="format"></a><span data-ttu-id="adee6-554">Формат</span><span class="sxs-lookup"><span data-stu-id="adee6-554">Format</span></span>

<span data-ttu-id="adee6-555">Семь цифр, за которыми следует один символ</span><span class="sxs-lookup"><span data-stu-id="adee6-555">Seven digits followed by one character</span></span>
  
### <a name="pattern"></a><span data-ttu-id="adee6-556">Шаблон</span><span class="sxs-lookup"><span data-stu-id="adee6-556">Pattern</span></span>

<span data-ttu-id="adee6-557">Семь цифр, за которыми следует один символ</span><span class="sxs-lookup"><span data-stu-id="adee6-557">Seven digits followed by one character</span></span>
  
- <span data-ttu-id="adee6-558">семь цифр;</span><span class="sxs-lookup"><span data-stu-id="adee6-558">Seven digits</span></span>
    
- <span data-ttu-id="adee6-559">Одна цифра или буква (без учета регистра)</span><span class="sxs-lookup"><span data-stu-id="adee6-559">One digit or letter (not case-sensitive)</span></span>
    
### <a name="checksum"></a><span data-ttu-id="adee6-560">Контрольная сумма</span><span class="sxs-lookup"><span data-stu-id="adee6-560">Checksum</span></span>

<span data-ttu-id="adee6-561">Неприменимо</span><span class="sxs-lookup"><span data-stu-id="adee6-561">Not applicable</span></span>
  
### <a name="definition"></a><span data-ttu-id="adee6-562">Определение</span><span class="sxs-lookup"><span data-stu-id="adee6-562">Definition</span></span>

<span data-ttu-id="adee6-563">Политика защиты от потери данных с вероятностью в 75 % верно обнаруживает этот тип конфиденциальной информации, если в расположении, не отдаленном более чем на 300 знаков:</span><span class="sxs-lookup"><span data-stu-id="adee6-563">A DLP policy is 75% confident that it's detected this type of sensitive information if, within a proximity of 300 characters:</span></span>
  
- <span data-ttu-id="adee6-564">Регулярное выражение `Regex_spain_eu_national_id_card` находит содержимое, которое соответствует шаблону.</span><span class="sxs-lookup"><span data-stu-id="adee6-564">The regular expression  `Regex_spain_eu_national_id_card` finds content that matches the pattern.</span></span> 
    
- <span data-ttu-id="adee6-565">Найдено ключевое `Keywords_spain_eu_national_id_card"` слово FROM.</span><span class="sxs-lookup"><span data-stu-id="adee6-565">A keyword from  `Keywords_spain_eu_national_id_card"` is found.</span></span> 
...
### <a name="keywords"></a><span data-ttu-id="adee6-566">Ключевые слова</span><span class="sxs-lookup"><span data-stu-id="adee6-566">Keywords</span></span>

#### <a name="keywordsspaineunationalidcard"></a><span data-ttu-id="adee6-567">Кэйвордс_спаин_еу_натионал_ид_кард</span><span class="sxs-lookup"><span data-stu-id="adee6-567">Keywords_spain_eu_national_id_card</span></span>

<span data-ttu-id="adee6-568">DNI</span><span class="sxs-lookup"><span data-stu-id="adee6-568">dni</span></span>
  
<span data-ttu-id="adee6-569">Национальный идентификационный номер</span><span class="sxs-lookup"><span data-stu-id="adee6-569">national identification number</span></span>
  
<span data-ttu-id="adee6-570">Национальный идентификационный номер</span><span class="sxs-lookup"><span data-stu-id="adee6-570">national identity number</span></span>
  
<span data-ttu-id="adee6-571">страховой номер</span><span class="sxs-lookup"><span data-stu-id="adee6-571">insurance number</span></span>
  
<span data-ttu-id="adee6-572">персональный идентификационный номер</span><span class="sxs-lookup"><span data-stu-id="adee6-572">personal identification number</span></span>
  
<span data-ttu-id="adee6-573">Национальная идентификация</span><span class="sxs-lookup"><span data-stu-id="adee6-573">national identity</span></span>
  
<span data-ttu-id="adee6-574">личный идентификатор</span><span class="sxs-lookup"><span data-stu-id="adee6-574">personal identity no</span></span>
  
<span data-ttu-id="adee6-575">уникальный идентификационный номер</span><span class="sxs-lookup"><span data-stu-id="adee6-575">unique identity number</span></span>
  
<span data-ttu-id="adee6-576">натионалидно #</span><span class="sxs-lookup"><span data-stu-id="adee6-576">nationalidno#</span></span>
  
<span data-ttu-id="adee6-577">уникальным</span><span class="sxs-lookup"><span data-stu-id="adee6-577">uniqueid#</span></span>
  
<span data-ttu-id="adee6-578">DNI</span><span class="sxs-lookup"><span data-stu-id="adee6-578">dni#</span></span>
  
<span data-ttu-id="adee6-579">натионалид #</span><span class="sxs-lookup"><span data-stu-id="adee6-579">nationalid#</span></span>
  
<span data-ttu-id="adee6-580">ние #</span><span class="sxs-lookup"><span data-stu-id="adee6-580">nie#</span></span>
  
<span data-ttu-id="adee6-581">ние</span><span class="sxs-lookup"><span data-stu-id="adee6-581">nie</span></span>
  
<span data-ttu-id="adee6-582">ниенúмеро #</span><span class="sxs-lookup"><span data-stu-id="adee6-582">nienúmero#</span></span>
  
<span data-ttu-id="adee6-583">ние нúмеро</span><span class="sxs-lookup"><span data-stu-id="adee6-583">nie número</span></span>
  
<span data-ttu-id="adee6-584">документо наЦионал де ИДЕНТИДАД</span><span class="sxs-lookup"><span data-stu-id="adee6-584">documento nacional de identidad</span></span>
  
<span data-ttu-id="adee6-585">ИДЕНТИДАД úнико</span><span class="sxs-lookup"><span data-stu-id="adee6-585">identidad único</span></span>
  
<span data-ttu-id="adee6-586">нúмеро наЦионал ИДЕНТИДАД</span><span class="sxs-lookup"><span data-stu-id="adee6-586">número nacional identidad</span></span>
  
<span data-ttu-id="adee6-587">DNI нúмеро</span><span class="sxs-lookup"><span data-stu-id="adee6-587">dni número</span></span>
  
<span data-ttu-id="adee6-588">днинúмеро #</span><span class="sxs-lookup"><span data-stu-id="adee6-588">dninúmero#</span></span>
  
<span data-ttu-id="adee6-589">идентидадúнико #</span><span class="sxs-lookup"><span data-stu-id="adee6-589">identidadúnico#</span></span>
  
## <a name="sweden"></a><span data-ttu-id="adee6-590">Швеция</span><span class="sxs-lookup"><span data-stu-id="adee6-590">Sweden</span></span>

<span data-ttu-id="adee6-591">Для получения дополнительных сведений обратитесь к разделу "Швеции National ID", в котором [ищутся типы конфиденциальной информации](what-the-sensitive-information-types-look-for.md).</span><span class="sxs-lookup"><span data-stu-id="adee6-591">For details, see the section "Sweden National ID" in [What the sensitive information types look for](what-the-sensitive-information-types-look-for.md).</span></span>
  
## <a name="see-also"></a><span data-ttu-id="adee6-592">См. также</span><span class="sxs-lookup"><span data-stu-id="adee6-592">See also</span></span>

[<span data-ttu-id="adee6-593">Что позволяют искать типы конфиденциальной информации</span><span class="sxs-lookup"><span data-stu-id="adee6-593">What the sensitive information types look for</span></span>](what-the-sensitive-information-types-look-for.md)
