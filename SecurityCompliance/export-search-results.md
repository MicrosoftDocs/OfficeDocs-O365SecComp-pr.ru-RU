...
После успешного выполнения поиска контента можно экспортировать результаты поиска на локальный компьютер. При экспорте результатов электронной почты они загружаются на компьютер в виде PST-файлов. При экспорте контента из сайтов SharePoint и OneDrive для бизнеса экспортируются копии собственных документов Office. В результаты экспортированного поиска включены дополнительные документы и отчеты.
...
Первым этапом является подготовка результатов поиска для экспорта. При подготовке результатов они передаются в место хранения Azure в облаке Майкрософт. Обратите внимание, что содержимое из почтовых ящиков и сайтов отправляются с максимальным количеством в 2 ГБ в час.
...
- Экспорт результатов поиска из центра безопасности &amp; и соответствия требованиям имеет следующие пределы:
...
- При экспорте результатов поиска в дополнение к результатам поиска включаются следующие отчеты.
  ...
  - **Результаты** Документ Excel, который содержит сведения о каждом элементе, загружаемом в виде результатов поиска. Для электронной почты журнал результатов содержит сведения о каждом сообщении, в том числе: 
...
- Все результаты поиска и отчеты экспорта включаются в папку, имя которой совпадает с именем поиска контента. Экспортированные сообщения электронной почты расположены в папке **Exchange**. Документы располагаются в папке с именем **SharePoint**. 
    
- Метаданные файловой системы для документов на сайтах SharePoint и OneDrive для бизнеса поддерживаются при экспорте документов на локальный компьютер. Это означает, что свойства документа, такие как создание и Дата последнего изменения, не изменяются при экспорте документов.
