...
1. **Подключение к интерфейсу PowerShell Центра безопасности и соответствия требованиям** — см. [эту статью](https://go.microsoft.com/fwlink/p/?linkid=799771).
