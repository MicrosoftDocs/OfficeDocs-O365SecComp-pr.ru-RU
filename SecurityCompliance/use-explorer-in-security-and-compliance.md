...
Предположим, вы хотите увидеть почтовые сообщения с помощью URL-адресов, включая список разрешенных, заблокированных и переопределенных URL-адресов.  Для идентификации URL-адресов, которые были выбраны, требуются [безопасные ссылки ATP](atp-safe-links.md). (Убедитесь, что вы настроили и применили [политики безопасных ссылок ATP](set-up-atp-safe-links-policies.md) для пользователей, чтобы защититься от щелчка, а также ведения журнала по ссылкам ВЕРДИКТС by ATP Safe Links.) Чтобы просмотреть URL-адреса фишинга в сообщениях и щелкать по URL-адресам в сообщениях фишинга, используйте _Гт_ "фишинг" в проводнике по [электронной почте](threat-explorer-views.md#email--phish) .
...
Отчет обновляется для отображения двух различных таблиц URL-адресов на вкладке URL-адрес ниже:
1. **Топ URL-адресов** это URL-адреса, содержащиеся в фильтруемых сообщениях, и количество действий по доставке для каждого URL-адреса. В представлении "фишинг сообщения" Этот список, как правило, содержит допустимые URL-адреса. Злоумышленники включают в свои сообщения сочетания хороших и недостоверных URL-адресов, чтобы попытаться доставить их, но они появятся в списке более интересной, чтобы пользователи могли щелкнуть. Таблица URL-адресов сортируется по общему количеству сообщений (Примечание: этот столбец не отображается для упрощения представления).
2. **Наиболее посещаемые щелчки** — это безопасные ссылки, которые были выбраны, отсортированные по общему количеству щелчков (этот столбец также не отображается для упрощения представления). Общее количество подсчетов по столбцу указывает на безопасные ссылки нажмите кнопку счетчик вредоносности для каждого нажатого URL-адреса. В представлении "phishing-почта" часто встречаются подозрительные или вредоносные ссылки, но они могут включать очистку URL-адресов, которые должны находиться в сообщениях фишинга. URL-адреса, на которые вы щелкнете ссылки, не отображаются здесь.

В двух таблицах URL-адресов отображаются самые популярные URL-адреса в сообщениях фишинга по состоянию доставки и отображаются нажатия клавиш URL-адресов, которые были заблокированы (или посещены несмотря на предупреждение), что позволяет определить, какие потенциальные неправильные ссылки были получены пользователями и работали с пользователями. Отсюда вы можете провести дальнейший анализ. Например, под диаграммой можно увидеть самые популярные URL-адреса в сообщениях, заблокированных в среде Организации. 
