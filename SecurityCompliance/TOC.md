...
### [Ограничение доступа к содержимому с помощью шифрования в метках конфиденциальности](encryption-sensitivity-labels.md)
...
### [Рекомендации по началу работы с политикой DLP](get-started-with-dlp-policy-recommendations.md)
### [Начало работы с политикой защиты от потери данных по умолчанию](get-started-with-the-default-dlp-policy.md)
...
## [Диспетчер плана хранения](file-plan-manager.md)
...
### [Просмотр использования меток с помощью аналитики меток](label-analytics.md)
### [Просмотр отчетов для управления данными](view-the-data-governance-reports.md)
...
### [Краткое руководство по началу работы: настройка Office 365 ATP](checklist-atp-setup.md)
...
### [Контроль за исходящим спамом в Office 365](outbound-spam-controls.md)
...
### [Автоматическая очистка для защиты от спама и вредоносных программ](zero-hour-auto-purge.md)
...
### [Настройка политики защиты от спама](configure-your-spam-filter-policies.md)
...
#### [Дополнительные сведения об анализе подделок](learn-about-spoof-intelligence.md)
...
#### [Настройка функции управления правами на доступ к данным для использования локального сервера служб Active Directory Rights Management](configure-irm-to-use-an-on-premises-ad-rms-server.md)
...
### [Поиск и освобождение сообщений на карантине для конечного пользователя](find-and-release-quarantined-messages-as-a-user.md)
...
### [Проверка запроса веб-части "Поиск контента" на ошибки](check-your-content-search-query-for-errors.md)
...
### [Дедупликация результатов поиска, выполненного с помощью функции обнаружения электронных данных](de-duplication-in-ediscovery-search-results.md)
...
### [Использование поиска содержимого для поиска списка пользователей в почтовом ящике и на сайте OneDrive для бизнеса](search-the-mailbox-and-onedrive-for-business-for-a-list-of-users.md)
### [Создание и удаление нескольких поисков содержимого, а также получение отчетов по ним](create-report-on-and-delete-multiple-content-searches.md)
...
### [Примечания к выпуску](compliance20/release-notes-ediscovery20.md)
...
### [Управление случаями удержания](compliance20/managing-holds.md)
...
## [Расширенное обнаружение электронных данных для Office 365](office-365-advanced-ediscovery.md)
...
## [Примечания к выпуску](datainvestigations/data-investigations-release-notes.md)
...
## [Управление пользователями, заинтересованными в исследовании](datainvestigations/manage-people-of-interest.md)
...
### [Как помочь гарантировать, что сообщение не будет помечено как спам](how-to-help-ensure-that-a-message-isn-t-marked-as-spam.md)
