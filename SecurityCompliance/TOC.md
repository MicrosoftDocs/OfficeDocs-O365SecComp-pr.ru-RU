...
## [Последние обновления сведений о соответствии требованиям](new-updated-compliance-content.md)
...
## [Автоматическое изучение угроз и реагирование на них в Office 365](office-365-air.md)
...
### [Как работает автоматическое реагирование на инциденты](automated-investigation-response-office.md)
