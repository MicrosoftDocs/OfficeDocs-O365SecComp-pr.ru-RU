...
### [Запретить помечать почту как спам в EOP и Office 365](prevent-email-from-being-marked-as-spam-0.md)
...
### [Настройка политик защиты от фишинга Office 365 ATP](set-up-atp-anti-phishing-policies.md)
### [Как запретить помечать настоящую почту как спам в Office 365](prevent-email-from-being-marked-as-spam.md)
...
### [Office 365 ATP для SharePoint, OneDrive и Microsoft Teams](atp-for-spo-odb-and-teams.md)
#### [Включение ATP для SharePoint, OneDrive и Microsoft Teams](turn-on-atp-for-spo-odb-and-teams.md)
#### [Вредоносные файлы в SharePoint, OneDrive или Microsoft Teams](malicious-files-detected-in-spo-odb-or-teams.md)
### [Просмотр отчетов для ATP](view-reports-for-atp.md)
...
## [Защита сайтов и файлов SharePoint Online](https://docs.microsoft.com/Office365/Enterprise/secure-sharepoint-online-sites-and-files)
