...
5. На странице " **Подтверждение параметров обращения** " можно изменить имя и описание дела и выбрать другую тему данных. В противном случае просто нажмите кнопку **сохранить**.
    ...
    b. При нажатии кнопки **Готово** закрывается новое обращение к КОММУТАТОРУ серии DSR без запуска встроенного поиска. При выборе этого параметра новый вариант серии DSR отображается на странице " **запросы субъектОв данных** ".
...
3. На странице **результатов экспорта** выберите эти Рекомендуемые параметры для экспорта данных об использовании. 
    ...
    b. В разделе **Экспорт контента Exchange как**выберите второй вариант, **один PST-файл с всеми сообщениями**.
