...
|:-----|:-----|
|Area  <br/> |Tasks  <br/> |
|Управление безопасностью  <br/> |• Проверьте контрольный рейтинг и запишите текущую оценку ( [https://securescore.office.com](https://securescore.office.com)).  <br/>  • Включите ведение журнала аудита для Office 365. [В разделе Поиск в журнале аудита в центре безопасности &amp; и соответствия требованиям Office 365](search-the-audit-log-in-security-and-compliance.md).<br/> • [Настройте клиент Office 365 для повышения безопасности](tenant-wide-setup-for-increased-security.md) .  <br/>  • Регулярно изучите панели мониторинга и отчеты в центре безопасности и соответствия требованиям Office 365 и Cloud App Security.  <br/> |
...
|:-----|:-----|
|Area  <br/> |Задача  <br/> |
|Управление безопасностью  <br/> |• Продолжайте планировать дальнейшие действия с помощью параметра Secure [https://securescore.office.com](https://securescore.office.com)Score ().  <br/>  • Продолжайте регулярно просматривать панели мониторинга и отчеты в центре безопасности и соответствия требованиям Office 365, средствах Cloud App Security и SIEM.  <br/>  • Продолжайте искать и внедрять обновления программного обеспечения.  <br/>  • Интегрируйте обнаружение электронных данных с вашими юридическими и безугрозными процессами.  <br/> |
...
|Защита информации  <br/> | • Уточнение политик и рабочих процессов.  <br/>  • Используйте защиту удостоверений Azure AD, чтобы определить угрозы для оценки.  <br/> |
