...
## <a name="step-1-create-a-csv-file-for-creating-the-labels"></a>Шаг 1. Создание CSV-файла для создания меток
...
## <a name="step-5-run-the-powershell-script-to-create-and-publish-the-labels"></a>Шаг 5. Запуск скрипта PowerShell для создания и публикации меток
