...
С помощью приведенных ниже скриптов и CSV-файлов вы можете массово создавать метки хранения и публиковать соответствующие политики. Необходимо сначала создать списки меток и политик хранения в Excel, а затем массово создать метки хранения и соответствующие политики на основе этих списков при помощи PowerShell. Это позволяет одновременно создать и опубликовать все метки хранения согласно вашему расписанию хранения.
...
- Если исходный файл для публикации меток хранения не указан, скрипт создает метки хранения (см. предыдущий раздел), но не публикует их.
...
- Скрипт публикует только те метки хранения, которые вручную применяются к контенту. Этот скрипт не поддерживает метки хранения, автоматически применяемые к контенту.
