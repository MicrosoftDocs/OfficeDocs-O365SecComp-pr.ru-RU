...
8. Для создания дополнительных меток нажмите кнопку **Создать метку** и повторите действия с 3 по 7.

9. Повторите действия с 3 по 8 для дополнительных меток со следующими именами:
