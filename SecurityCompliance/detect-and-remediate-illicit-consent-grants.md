...
2. Перейдите к узлу **поиска & расследования** и выберите Поиск в **журнале аудита** .
...
Простой способ проверить атаки незаконных Grant соглашаетесь должна выполняться [Get-AzureADPSPermissions.ps1](https://gist.github.com/psignoret/41793f8c6211d2df5051d77ca3728c09), который выгружать предоставляет разрешения OAuth и разрешения приложений для всех пользователей в вашем клиенте в один CSV-файл. 
...
5. Запустите командную строку PowerShell следующим образом:`.Get-AzureASPSPermissions.ps1 | Export-csv -path "Permissions.csv" -NoTypeInformation`
