...
По мере [добавления новых функций в ATP](office-365-atp.md#new-features-in-office-365-atp)группа безопасности Office 365 может добавить или изменить политики безопасных ссылок ATP в Организации. Кроме того, вы можете заметить изменения и улучшения, такие как новые пересмотренные [страницы предупреждений](atp-safe-links-warning-pages.md) и визуализация собственных ссылок в Outlook.
...
- **Политики безопасных ссылок ATP настраиваются** для электронной почты и документов Word, Excel, PowerPoint и Visio. (См. раздел [Настройка политик безопасных ссылок ATP в Office 365](set-up-atp-safe-links-policies.md)).

- **Клиентские приложения Office 365 настроены для использования современной проверки** подлинности (это предназначено для защиты безОпасных ссылок ATP в документах Office). (См. [современная проверка подлинности для Office 2016](https://docs.microsoft.com/office365/enterprise/modern-auth-for-office-2013-and-2016)). 
