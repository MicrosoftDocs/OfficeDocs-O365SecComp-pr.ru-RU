...
> [!TIP]
> Возможно, вы захотите приостановить и прочесть сведения о том, как создать ["Allow-(или надежный" отправитель)](create-safe-sender-lists-in-office-365.md) и [блокировать списки](create-block-sender-lists-in-office-365.md).
