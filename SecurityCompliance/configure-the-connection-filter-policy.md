...
5. В поле **Указать IP-адреса** явным образом укажите диапазон IP-адресов, а затем последовательно нажмите кнопки **Добавить**![Значок добавления](media/ITPro-EAC-AddIcon.gif) и **ОК**.
...
5. В поле **Указать IP-адреса** явным образом укажите IP-адрес или диапазон IP-адресов, внесенный в список разрешенных IP-адресов, а затем последовательно нажмите кнопки **Добавить**![Значок добавления](media/ITPro-EAC-AddIcon.gif) и **ОК**.
...
8. В поле **Указание домена** введите домен, к которому требуется применить обход фильтрации нежелательной почты, например **contosob.com**. Нажмите кнопку **Добавить**![Значок добавления](media/ITPro-EAC-AddIcon.gif), чтобы переместить домен в список фраз. Повторите это действие, чтобы добавить дополнительные домены в качестве исключений. Завершив настройку, нажмите кнопку **ОК**. 
