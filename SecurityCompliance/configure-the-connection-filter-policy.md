...
- Исходный IP-адрес в политике фильтра подключений также настраивается для локального входящего соединителя на основе IP в *любом* клиенте (Давайте назовем этого клиента a), **а** также клиента а и сервера Exchange Online Protection, который первым встречает сообщение в Office 365 оба могут находиться в одном лесу Active Directory в центрах обработки данных Майкрософт. В этом сценарии **ИПВ: Cal** добавляется в [заголовки сообщений защиты от нежелательной почты](anti-spam-message-headers.md) сообщения (что указывает на то, что обходится фильтрация нежелательной почты), но сообщение по-прежнему подвергается фильтрации нежелательной почты.
