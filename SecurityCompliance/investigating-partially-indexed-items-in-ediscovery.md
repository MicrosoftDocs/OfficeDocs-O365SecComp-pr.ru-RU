...
2. [Подключитесь к оболочке &amp; PowerShell центра безопасности Office 365](https://go.microsoft.com/fwlink/p/?linkid=627084).
    
3. В PowerShell &amp; центра соответствия требованиям безопасности перейдите в папку, в которой сохранен сценарий на шаге 1, а затем запустите сценарий. Например:
