...
Можно также использовать сторонние средства шифрования с Office 365, например PGP (Pretty Good Privacy). Office 365 не поддерживает стандарт PGP/MIME, и вы можете использовать только PGP/Inline для отправки и получения сообщений, зашифрованных с помощью PGP.
