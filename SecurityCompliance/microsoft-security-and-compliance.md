...
Если у вас есть другая подписка, например автономный план, включающий в себя центр безопасности Office 365 & соответствия требованиям, вы получите доступ к новому центру безопасности Майкрософт 365 и центру соответствия требованиям Майкрософт 365. Чтобы узнать больше, ознакомьтесь с [разпланом Microsoft 365](https://www.microsoft.com/microsoft-365/roadmap).
...
- Администраторы безопасности, операторы безопасности и средства чтения безопасности могут получать доступ к центру безопасности
 ...
 Чтобы узнать больше об этих ролях, ознакомьтесь [со статьей разрешения в центре безопасности & Office 365](permissions-in-the-security-and-compliance-center.md).
...
[Описание службы & безопасности центра соответствия требованиям Office 365](https://docs.microsoft.com/office365/servicedescriptions/office-365-platform-service-description/office-365-securitycompliance-center)
