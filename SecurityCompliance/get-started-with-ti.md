...
С помощью [проводника по угрозе (и обнаружения в реальном времени)](threat-explorer.md) можно анализировать угрозы, просматривать объемы атак по времени и анализировать данные по семействам угроз, инфраструктуре злоумышленников и т. д. Обозреватель угроз (также называемый проводником) — это начальное место для любого рабочего процесса анализа безопасности.
