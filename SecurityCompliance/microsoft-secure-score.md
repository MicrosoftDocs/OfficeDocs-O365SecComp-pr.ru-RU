...
## <a name="how-controls-are-scored"></a>Способ оценки элементов управления

Элементы управления можно оценить двумя способами. Некоторые из них оцениваются в двоичной манере — вы получаете 100% от оценки, если у вас есть компонент или параметр, настроенный в соответствии с рекомендациями. Другие показатели рассчитываются в процентах от общей конфигурации. Например, если в рекомендации по улучшению вы будете получать 30 баллов, если вы защитите всех пользователей с помощью MFA и у вас есть только 5 из 100 всего защищенных пользователей, то вы получили частичный балл на 2 точки (5 защищенных/100 всего ПТС = 2 ПТС частичный показатель) . 
