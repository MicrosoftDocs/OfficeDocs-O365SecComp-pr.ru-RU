...
- _инитиалдомаин_ — это домен, который вы использовали при регистрации в Office 365. Исходные домены всегда заканчиваются на onmicrosoft.com. Сведения о том, как определить начальный домен, приведены в статье [вопросы и ответы](https://support.office.com/article/1272bad0-4bd4-4796-8005-67d6fb3afc5a#bkmk_whydoihaveanonmicrosoft.comdomain)по доменам.
