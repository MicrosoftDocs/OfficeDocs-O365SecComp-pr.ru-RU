...
После включения политики защиты от спуфинга вы можете воспользоваться инструментами анализа угроз, чтобы получить примерное количество сообщений, которые помечаются как фишинговые. Чтобы сделать это, перейдите в Центр безопасности &amp; соответствия требованиям (SCC) в разделе Управления угрозами \> Проводник, установите Посмотреть помеченные как фишинговые, а затем выполните группировку по домену отправителя или состоянию защиты:
  
![Просмотр количества сообщений, помеченных как фишинговые](media/de25009a-44d4-4c5f-94ba-9c75cd9c64b3.jpg)
  
Вы можете взаимодействовать с различными отчеты, чтобы узнать, сколько сообщений были помечены как фишинговые, включая сообщения, помеченные как ПОДДЕЛКА. Дополнительные сведения см. в статье[Начало работы с инструментов управления угрозами в Office 365](get-started-with-ti.md)
