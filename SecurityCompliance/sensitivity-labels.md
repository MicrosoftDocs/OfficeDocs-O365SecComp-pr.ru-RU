...
- **Применять метку по умолчанию** ко всем новым документам и сообщениям электронной почты, созданным пользователями и группами, включенными в политику меток. Эта используемая по умолчанию метка может устанавливать базовый уровень параметров защиты, которые нужно применять ко всему содержимому. (Обратите внимание, что)
