...
1. **Если содержимое изменяется или удаляется** во время периода хранения, копия исходного содержимого по состоянию на момент назначения политики хранения создается в архивной библиотеке. Периодически запускается задание таймера, определяющее элементы с истекшим сроком хранения, и эти элементы удаляются в течение семи дней после окончания периода хранения без возможности восстановления. 
