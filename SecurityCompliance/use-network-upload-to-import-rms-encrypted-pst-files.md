...
[Шаг 1: Настройка управления правами Azure для импорта PST-файлов](#step-1-set-up-azure-rights-management-for-pst-import)
...
2. Чтобы задать URL-адрес для общего доступа к ключам RMS, выполните указанную ниже команду.
    ...
    |**Location**|**Расположение для общего доступа к ключам RMS**|
    |:-----|:-----|
