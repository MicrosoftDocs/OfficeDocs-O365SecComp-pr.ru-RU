...
[Office 365 Advanced Threat protection](office-365-atp.md) План 2 включает автоматизированные возможности реагирования на инциденты, которые могут сэкономить время и усилия группы управления безопасностью при работе с оповещениями и угрозами. В этой статье приводятся сведения о том, как приступить к работе с возможностями AIR в Office 365. Чтобы узнать больше о работе воздуха, ознакомьтесь со статьей [автоматизированное реагирование на инциденты (AIR) в Office 365](automated-investigation-response-office.md).
