...
|**Группа рассылки**|**Адрес группы (псевдоним)**|**Description**|
|:-----|:-----|:-----|
...
| Все ответственные за соответствие требованиям в США | US_Compliance@Contoso.com  | Эта группа содержит адреса электронной почты всех ответственных за соблюдение требований из США, которые работают в компании Contoso. Так как эта группа является подмножеством всех брокеров из США, вы можете использовать этот псевдоним для исключения руководителей соответствия требованиям из политики контроля. |
