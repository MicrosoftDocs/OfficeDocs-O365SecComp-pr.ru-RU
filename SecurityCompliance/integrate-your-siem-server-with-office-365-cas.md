...
## <a name="integrate-office-365-cloud-app-security"></a>Интеграция безопасности облаке приложения Office 365
    
### <a name="step-1-set-it-up-in-the-office-365-cloud-app-security-portal"></a>Этап 1: Настройка его на портале облачных приложений Office 365 безопасности
...
### <a name="step-2-download-the-jar-file-and-run-it-on-your-server"></a>Шаг 2: Загрузите файл БАНКЕ и запустите его на сервере
...
2. Извлеките файл .jar из ZIP-папку и запустите его на сервере.
...
- Рекомендуется запускать заливки БАНКЕ на сервере во время установки сервера.
...
## <a name="regenerating-your-token"></a>Повторное создание ключа

При разрыве вашей маркера, всегда можно восстановить его. В таблице найдите строку для агента SIEM. Нажмите кнопку с многоточием и выберите **восстановить маркер**.

![Обновите маркера, нажав кнопку с многоточием для агента SIEM](media/04de368a-b88e-4a9c-a830-58025cb98db6.png)
  
## <a name="editing-your-siem-agent"></a>Редактирование агента SIEM

Для изменения агента SIEM, таблицы, найдите строку для агента SIEM. Нажмите кнопку с многоточием и выберите команду **Изменить**. Если изменить агента SIEM, не требуется повторно запустите файл .jar; автоматически обновляется.
...
Для удаления агента SIEM, таблицы, найдите строку для агента SIEM. Нажмите кнопку с многоточием и затем выберите команду **Удалить**.

![Чтобы удалить SIEM агентов, щелкните многоточие и нажмите кнопку Удалить.](media/540b5bdf-5574-4ecc-a7b0-92a499a387d7.png)

## <a name="sample-logfiles"></a>Пример файлов журнала
