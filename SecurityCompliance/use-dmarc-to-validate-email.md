...
- Администраторы могут создать правило потока почты Exchange (также известное как правило транспорта) для всех пользователей, которое разрешает отправку сообщений для таких обозначенных отправителей. 
