...
## <a name="spoof-mail-report"></a>Отчет о подДельной почте

В **** отчете о поддельНой подделке показано количество обнаруженных поддельных почтовых сообщений, а также сведения о том, какие из них были признаны "хорошими" (подмена почты выполнена по законным бизнес-причинам). 
...
## <a name="user-reported-messages-report-new"></a>Отчет о сообщениях, отправленных пользователями (New!)
