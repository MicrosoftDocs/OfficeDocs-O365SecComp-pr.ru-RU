...
> [!NOTE]
>  Количество сообщений остановится на 50 000, и в отчете будет отображаться только это значение в консоли. Командлет Get – HistoricalSearch командлета PowerShell покажет истинное количество сообщений.
