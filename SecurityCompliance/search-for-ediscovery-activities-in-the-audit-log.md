...
|**Понятное имя**|**Operation**|**Соответствующий командлет**|**Description**|
|:-----|:-----|:-----|:-----|
...
|Скачанный экспорт поиска контента  <br/> |Сеарчекспортдовнлоадед  <br/> |Н/Д  <br/> |Пользователь загрузил результаты поиска контента на локальный компьютер. Обратите внимание, что **начат экспорт** действий по поиску контента, прежде чем можно будет скачать результаты поиска.  <br/> |
...
|**Понятное имя**|**Операция (командлет)**|**Description**|
|:-----|:-----|:-----|
...
|Version  <br/> |Указывает номер версии действия (определяемого свойством Operation), который записывается в журнал.  <br/> |
