...
Метку на основе события, как и любую другую, необходимо автоматически применить к событию или опубликовать, чтобы ее можно было применять вручную. Это можно сделать на странице **Метки** или **Политики меток**. 
