...
## <a name="identifying-mailboxes-on-hold-because-a-label-has-been-applied-to-a-folder-or-item"></a>Идентификационные почтовые ящики на хранение так, как была применена метка папку или элемент
