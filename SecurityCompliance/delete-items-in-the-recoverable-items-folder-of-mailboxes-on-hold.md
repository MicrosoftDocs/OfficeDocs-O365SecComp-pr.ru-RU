...
Чтобы проверить, удержание задержки был удален, выполните следующую команду.

```
Get-Mailbox <username> | FL DelayHoldApplied
```

Значение **False** для свойства *DelayHoldApplied* указывает, что было удалено задержки.
