...
---
# <a name="set-up-azure-rights-management-for-office-365-message-encryption"></a>Настройка службы управления правами Azure для шифрования сообщений Office 365
...
## <a name="prerequisites-for-using-office-365-message-encryption"></a>Предварительные условия для использования шифрования сообщений Office 365
...
## <a name="activate-azure-rights-management-for-ome-in-office-365"></a>Активация службы управления правами Azure для OME в Office 365
...
## <a name="set-up-ome-to-use-azure-rms-by-importing-trusted-publishing-domains-tpds"></a>Настройка OME для использования службы управления правами Azure путем импорта доверенные домены публикации (доверенных доменов публикации)
<a name="importTPDs"> </a>
...
## <a name="i-have-ome-set-up-with-active-directory-rights-management-not-azure-information-protection-what-do-i-do"></a>У меня есть OME настройку с помощью управления правами Active Directory Azure защита информации, что делать?
<a name="importTPDs"> </a>
