...
Организация контента в рабочем наборе важна для выполнения различных рабочих процессов в процессе обнаружения электронных данных. Это достигается за счет следующего:

-  Отбор ненужного контента.

- Определение релевантного контента.
