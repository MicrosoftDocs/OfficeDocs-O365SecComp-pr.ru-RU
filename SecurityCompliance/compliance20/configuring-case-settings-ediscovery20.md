...
---
# <a name="configuring-case-settings-in-advanced-ediscovery-preview"></a>Настройка параметров вариантов в расширенной обнаружения электронных данных (Предварительная версия)
