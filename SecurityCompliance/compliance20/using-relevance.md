...
В Advanced eDiscovery модуль релевантности включает обучение релевантности и обзор файлов, связанных с обращением. Чтобы использовать рабочий процесс релевантности, перейдите к разделу Управление набором проверки в наборе проверки и нажмите кнопку Показать релевантность. Для запуска рабочего процесса необходимо выполнить несколько действий.

- Процесс: каждый набор нагрузок, добавленный в набор проверки, будет отображаться как "контейнер". Эти документы необходимо обработать, прежде чем их можно будет добавить в модуль релевантности; Кроме того, вы можете пометить их как заполненные или предварительно помеченные для конкретной ситуации.

- Добавить в соответствие: под загрузкой релевантности \> вы можете добавлять документы, которые были обработаны, чтобы сделать их доступными для обучения.

Рабочий процесс релевантности отображается и описывается следующим образом:
...
- **Тест**: результаты можно проверить, чтобы проверить правильность и эффективность расширенной обработки обнаружения электронных данных.

- **Поиск**: после завершения рабочего процесса релевантности вы можете использовать такие выходные данные, как Read персентиль документа для вашего вопроса при выполнении запроса в наборе рецензирования.
