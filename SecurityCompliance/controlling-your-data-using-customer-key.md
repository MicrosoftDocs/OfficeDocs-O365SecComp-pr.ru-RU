...
4. Чтобы создать DEP, используйте командлет New – Dataencryptionpolicy используется, введя следующую команду:
   ...
   -  *KeyVaultURI1* — универсальный код ресурса (URI) для первого ключа в политике. Пример: https://contoso_EastUSvault01.vault.azure.net/keys/USA_key_01. 
    
   -  *KeyVaultURI2* — универсальный код ресурса (URI) для второго ключа в политике. Пример: https://contoso_EastUS2vault01.vault.azure.net/keys/USA_Key_02. РазДеляйте два URI запятыми и пробелом. 
