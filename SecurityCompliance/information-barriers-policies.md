...
- **Политики для информационных барьеров** определяют ограничения на связь или ограничения. При определении политик барьера информации вы выбираете один из двух типов политик:
    - "Блокировать" политики, которые предотвращают связь одного сегмента с другим сегментом
    - Политики "разрешить", позволяющие одному сегменту связываться только с определенными другими сегментами
