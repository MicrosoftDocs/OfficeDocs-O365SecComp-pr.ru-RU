...
- Когда лицензия удаляется из почтового ящика, почтовый ящик переходит в 30-дневный период отсрочки. В течение этого периода отсрочки вы по-прежнему сможете выполнять поиск контента в почтовом ящике.

- Если почтовому ящику не возвращается лицензия в течение 30 дней, он помечается для окончательного удаления и удаляется из Office 365 при следующей обработке почтового ящика. В зависимости от даты обработки почтового ящика, вы сможете выполнять в нем поиск по истечении 30-дневного периода отсрочки. Обычно почтовые ящики обрабатываются каждые семь дней. После обработки почтовый ящик удаляется и больше недоступен для поиска.

- Если существующий поиск контента выполняется в почтовом ящике, из которого удалена лицензия, отключенный почтовый ящик будет включаться в повторный поиск до истечения 30-дневного периода отсрочки. После истечения периода отсрочки и удаления почтового ящика он больше не будет включаться в повторный поиск.

- Если лицензия удаляется из почтового ящика, помещенного на удержание (с помощью различных [функций удержания в Office 365](identify-a-hold-on-an-exchange-online-mailbox.md)), почтовый ящик хранится бессрочно и остается доступным для поиска по истечении 30-дневного периода отсрочки.
