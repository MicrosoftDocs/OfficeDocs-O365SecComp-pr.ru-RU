...
> [!IMPORTANT]
> Уведомление о том, когда отправитель ограничен, теперь входит в состав системы оповещения центра безопасности &. Вместо методов, описанных ниже, для отправки уведомления список пользователей для оповещения можно найти в оповещении "пользователь запретил отправку электронной почты". Чтобы настроить оповещение, откройте [страницу политики оповещений](https://sip.protection.office.com/alertpolicies) в центре безопасности & соответствия требованиям, так как в будущем метод будет удален. Узнайте о новом интерфейсе " [ограниченные пользователи](https://docs.microsoft.com/en-us/Office365/SecurityCompliance/removing-user-from-restricted-users-portal-after-spam)". "
