...
- **URL-адрес сайта или адрес электронной почты** Введите адрес электронной почты custodian, чтобы возвратить список идентификаторов папки и папки почтового ящика Exchange. Или введите URL-адрес для сайта SharePoint или OneDrive для бизнеса сайта, чтобы возвратить список путей для указанного сайта. Вот несколько примеров: 
...
5. В разделе, **выберите раздел "мне нравится" для поиска**, выполните одно из следующих действий на основе ли выполняется поиск почтового ящика или папка сайта:
...
Будьте в виду следующее при использовании скрипта в этой статье для выполнения целевого семейства сайтов.
...
- При поиске папки почтовых ящиков, только в указанной папке (обозначенный его `folderid` свойство) будет осуществляться. Вложенные папки не будет искать. Чтобы выполнить поиск вложенных папок, необходимо использовать идентификатор папки для вложенных папок, который нужно найти. 
