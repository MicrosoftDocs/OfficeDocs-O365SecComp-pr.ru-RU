...
Для работы надстройки "сообщение отчета" в существующем веб-браузере достаточно. Тем не менее, если вы заметили, что надстройка недоступна или не работает должным образом, попробуйте другой браузер.
...
3. Ознакомьтесь с условиями использования и политики конфиденциальности. Нажмите кнопку **Continue** (Продолжить). 
