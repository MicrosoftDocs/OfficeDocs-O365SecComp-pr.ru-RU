...
В зависимости от того, какой выбран с помощью мастера пользователи в вашей организации будет иметь сообщения отчета надстройки недоступны. Пользователи в вашей организации отображаются следующие значки: 
