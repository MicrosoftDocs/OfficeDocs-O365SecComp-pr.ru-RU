...
В этом разделе описаны действия, необходимые для активации и задайте его копирования Azure управления правами, частью защита информации Azure, для использования с предыдущей версии шифрования сообщений Office 365 (OME).
