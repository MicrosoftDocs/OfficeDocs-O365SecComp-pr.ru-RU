...
**Сводка**. Динамическая доставка — это вариант, который можно выбрать для [безОпасных вложений ATP](atp-safe-attachments.md). В этой статье рассказывается о возможностях динамической доставки и предварительного просмотра вложений в [безопасных вложениях ATP в Office 365](atp-safe-attachments.md).
...
- Если у получателя нет политики безОпасных вложений ATP, то электронная почта и вложение будут проходить без проверки безОпасных вложений ATP и заполнительов вложений.
...
- Электронная почта Организации должна размещаться в Office 365
    
## <a name="are-there-scenarios-for-which-dynamic-delivery-is-not-available"></a>Существуют ли сценарии, для которых динамическая доставка недоступна?
