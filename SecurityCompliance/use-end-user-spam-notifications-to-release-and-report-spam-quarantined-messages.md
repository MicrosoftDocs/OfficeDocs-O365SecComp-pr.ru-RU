...
> [!NOTE]
>  Сообщения, помещенные в карантин из-за того, что правило обработки почтового процесса (также известное как), не включаются в сообщения, помещенные в карантин пользователя. В списке отображаются только сообщения, помещенные в карантин спама. _Гт_ вы можете выпустить сообщение и сообщить о нем как ложное срабатывание (не спама) один раз. 
