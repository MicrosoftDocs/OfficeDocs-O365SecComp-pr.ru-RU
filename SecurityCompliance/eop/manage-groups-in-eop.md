...
2. Нажмите кнопку **Создать**![Значок добавления](../media/ITPro-EAC-AddIcon.png), а затем щелкните **Группа рассылки** или **Группа безопасности** в зависимости от ваших потребностей. Отличия между этими группами см. в разделе [Типы групп с включенной поддержкой почты](manage-groups-in-eop.md). 
...
3. На странице **Создать группу рассылки** или **Создать группу безопасности** заполните приведенные ниже поля. 
  ...
  - **Владельцы**. По умолчанию владельцем группы становится ее создатель. Добавить владельцев можно с помощью кнопки **Добавить**![Значок добавления](../media/ITPro-EAC-AddIcon.png). Для каждой группы должен существовать по крайней мере один владелец.
    
    > [!NOTE]
    > Владельцы не обязательно должны быть членами группы. 
  
  - **Члены**. В этом разделе можно добавить членов группы и указать, требуется ли утверждение для пользователей, желающих присоединиться к группе или покинуть ее. Чтобы добавить пользователей в группу, нажмите кнопку **Добавить**![Значок добавления](../media/ITPro-EAC-AddIcon.png).
...
2. Выполните одно из указанных ниже действий.
  ...
  - Изменение группы В списке групп выберите группу рассылки или безопасности, которую необходимо просмотреть или изменить, а затем нажмите кнопку **Изменить**![Значок редактирования](../media/ITPro-EAC-EditIcon.png). При необходимости вы можете обновить общие параметры, а также добавить или удалить владельцев и членов группы.
    
  - Удаление группы Выберите группу и нажмите кнопку **Удалить**![Значок "Удалить"](../media/ITPro-EAC-RemoveIcon.png).
