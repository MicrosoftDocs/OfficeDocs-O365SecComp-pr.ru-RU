...
- Использовать метки и типы конфиденциальной информации с Cloud App Security для отслеживания персональных данных, которые хранятся в других приложениях SaaS.
...
Метки конфиденциальности можно применять к почте в Exchange Online. Кроме того, их можно использовать при защите от потери данных в Office 365. 
...
<td align="left">Перейдите в раздел "Классификации" в Центре безопасности и соответствия требованиям, выберите "Метки хранения" и создайте метки для вашей среды.</td>
</tr>
<tr class="odd">
