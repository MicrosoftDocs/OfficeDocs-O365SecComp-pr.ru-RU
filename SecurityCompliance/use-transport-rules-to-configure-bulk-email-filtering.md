...
---
# <a name="use-mail-flow-rules-to-configure-bulk-email-filtering-in-exchange-online-protection"></a>Использование правил потока почты Настройка фильтрации в Exchange Online Protection массовыми сообщениями электронной почты
...
### <a name="create-mail-flow-rule-to-filter-bulk-email-messages-based-on-text-patterns"></a>Создание правила поток почты для фильтрации массовых сообщений электронной почты на основе текстовых шаблонов
...
### <a name="create-a-mail-flow-rule-to-filter-bulk-email-messages-based-on-phrases"></a>Создание правила потока обработки почты для фильтрации массовых сообщений электронной почты на основе фраз
